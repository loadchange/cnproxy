 ...
 *
 * Serious proxies (mitmproxy, whistle, Reqable) capture and let you edit the DECODED body even
 * when the wire is gzip/br/deflate. We decode on capture so the inspector and body filters
